 ...
 * prepared to write it yourself in future challenges.
 * 
 ...
 * Output Format
 * 
 * Code that prints the sum calculated and returned by solveMeFirst is provided for you in the
 * editor.
 * 
 * @author Deepak
 *
 */
public class Q01SolveMeFirst {
